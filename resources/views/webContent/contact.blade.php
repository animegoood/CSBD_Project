            ...
            <div class="row mb-30">
                ...
                <div class="col-lg-7 wow customFadeInUp slow">
                      ...
                      <div class="card-body">
                        <form  action="{{ route('contact_mail') }}" method="post">
                            ...
                            <div class="m-4" >
                                ...
                                <input id ="name" style="padding: 2rem; font-size:1.5rem;" placeholder="Your Name" class="form-control"type="text" name="send_message_name">
                            ...
                            <div class="m-4" >
                                ...
                                <input id ="name" style="padding: 2rem; font-size:1.5rem;" placeholder="ABCD@gmail.com" class="form-control"type="email" name="send_message_email">
                            ...
                            <div class="m-4" >
                                ...
                                <textarea  rows="5" id ="name" style="padding: 2rem; font-size:1.5rem;" placeholder=" Your Message" class="form-control"type="text" name="send_message_message"></textarea>
                    ...
                    @csrf
                      ...
                      <div class="form-group">
                          <input type="text" name="send_message_name" id="name" class="form-control" placeholder="Name"  >
                      </div>
                      ...
                      <div class="form-group">
                          <textarea name="send_message_message" id="message" cols="30" rows="5" class="form-control" placeholder="Message" ></textarea>
                      </div>
                ...
                <div class="col-lg-5 wow customFadeInUp delay-0-4s slow">
                    <div class="google-map mb-30">
                        <iframe
                            src="{{ url('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3104.5761533072873!2d-78.19644468515456!3d38.91080675375955!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b5c5dc680d0b2b%3A0x1e9ff0b6bb7a2f87!2s1000%20Proctor%20Ln%2C%20Front%20Royal%2C%20VA%2022630%2C%20%C3%89tats-Unis!5e0!3m2!1sfr!2sma!4v1578068093888!5m2!1sfr!2sma') }}"
                            allowfullscreen="">
                        </iframe>
                    </div>
                </div>
