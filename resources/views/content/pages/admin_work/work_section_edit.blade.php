                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" id="photography_name" value="{{ $work_section_details->photography_name }}" name="photography_name" class="form-control">
                        </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="mt-2">
                          ...
                          <input type="text"  value="{{ $work_section_details->illustrator_name }}" id="illustrator_name" name="illustrator_name" class="form-control">
                      </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="mt-2">
                        ...
                        <input value="{{ $work_section_details->graphicDesign_name }}" type="text" id="graphicDesign_name" name="graphicDesign_name" class="form-control">
                    </div>
